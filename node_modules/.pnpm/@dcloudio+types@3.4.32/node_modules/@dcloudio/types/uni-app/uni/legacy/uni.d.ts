declare namespace UniNamespace {
    ...
    interface EditorContext {
         ...
         * 插入提及某人的内容，格式为 @用户名
         */
        insertMention(options: EditorContextInsertMentionOptions): void;
        /**
         * 插入文本
         */
         ...
         * 插入链接
         */
        insertLink(options: EditorContextInsertLinkOptions): void;
        /**
    ...
    interface EditorContextInsertMentionOptions {
        /**
         * 被 @ 的人 id
         */
        id?: string;
    ...
    interface EditorContextInsertLinkOptions {
        /**
         * 文本内容
         */
        text: string;
