...
const independent_1 = require("./plugins/independent");
    ...
    return [
        ...
        ...(process.env.UNI_APP_X === 'true'
            ? [
                ...
                (0, uni_cli_shared_1.resolveUTSCompiler)().uts2js({
                    ...
                    extApi: (0, uni_cli_shared_1.initUts2jsExtApiOptions)(),
                    workers: {
                        extname: '.js',
        ...
        ...(process.env.UNI_COMPILE_TARGET === 'uni_modules'
            ...
            : [
                ...
                (0, independent_1.uniIndependentSubpackagePlugin)(options),
            ]),
