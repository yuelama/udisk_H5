...
const devPlugin_1 = require("./devPlugin");
function init() {
    const isDom2 = process.env.UNI_APP_X_DOM2 === 'true';
    const isDom2Dynamic = process.env.UNI_APP_X_DOM2_DYNAMIC === 'true';
    const isDev = process.env.NODE_ENV === 'development';
    const uasm = isDom2 ? (0, uni_cli_shared_1.initUasmTransformOptions)('app-ios') : undefined;
    const extApi = (0, uni_cli_shared_1.initUts2jsExtApiOptions)();
    return [
        (0, uni_cli_shared_1.uniUasmPlugin)(),
        ...
        ...(isDom2 && process.env.UNI_APP_X_VAPOR_SCRIPT_LANG === 'true'
            ? [
                (0, uni_cli_shared_1.uniVaporScriptPlugin)({
                    sharedDataLibName: !isDom2Dynamic
                        ? utils_1.SHARED_DATA_LIB_GLOBAL_NAME
                        : undefined,
        ...
        (0, uni_cli_shared_1.resolveUTSCompiler)().uts2js({
            ...
            sharedDataLibName: isDom2 && !isDom2Dynamic ? utils_1.SHARED_DATA_LIB_GLOBAL_NAME : undefined,
        ...
        ...(isDom2 && !isDom2Dynamic && (0, uni_cli_shared_1.isNormalCompileTarget)() && isDev
            ? [(0, devPlugin_1.uniAppXIOSEngineDevPlugin)()]
            : []),
    ];
}
exports.init = init;
