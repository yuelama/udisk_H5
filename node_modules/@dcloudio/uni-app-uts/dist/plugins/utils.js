...
exports.DOM2_CSS_CACHE_MAP = exports.isVue = exports.getExtApiComponents = exports.addExtApiComponents = exports.getGlobalPageOrientation = exports.setGlobalPageOrientation = exports.updateManifestModules = exports.updateHarmonyManifestModules = exports.normalizeManifestJson = exports.relativeInputDir = exports.configResolved = exports.isPages = exports.isManifest = exports.createUniOptions = exports.SHARED_DATA_LIB_GLOBAL_NAME = exports.SHARED_DATA_LIB_IMPORT_SOURCE = void 0;
const node_path_1 = __importDefault(require("node:path"));
const uni_shared_1 = require("@dcloudio/uni-shared");
const uni_cli_shared_1 = require("@dcloudio/uni-cli-shared");
const uni_i18n_1 = require("@dcloudio/uni-i18n");
const compiler_core_1 = require("@vue/compiler-core");
exports.SHARED_DATA_LIB_IMPORT_SOURCE = 'libentry.so';
exports.SHARED_DATA_LIB_GLOBAL_NAME = '__uniSharedDataLib';
        ...
        copyOptions() {
            ...
            return {
                assets: [
                    ...
                    ...(0, uni_cli_shared_1.resolveUasmCopyAssets)(platform, production),
                ],
                targets,
            };
        },
        compilerOptions: platform === 'app-ios' ||
                        ...
                        if (node.type === compiler_core_1.NodeTypes.ELEMENT &&
                            (node.tagType === compiler_core_1.ElementTypes.ELEMENT ||
                                (node.tagType === compiler_core_1.ElementTypes.COMPONENT &&
                                    (isDom2
                                        ? (0, uni_shared_1.isDom2AppVueComponentTag)(node.tag)
                                        : (0, uni_shared_1.isAppUVueBuiltInEasyComponent)(node.tag))))) {
                            if (!(0, uni_cli_shared_1.parseUTSComponent)(node.tag, platform === 'app-android' ? 'kotlin' : 'swift')) {
...
function configResolved(config, isAndroidVdom = false) {
    const enableVaporScriptLang = process.env.UNI_APP_X_DOM2 === 'true' &&
        process.env.UNI_APP_X_VAPOR_SCRIPT_LANG === 'true';
    // JS 引擎保留 Terser；启用 Vapor JS/TS 脚本时还需要 vite:esbuild 处理标准 TypeScript。
    const removedPlugins = REMOVED_PLUGINS.filter((plugin) => (isAndroidVdom || plugin !== 'vite:terser') &&
        (!enableVaporScriptLang || plugin !== 'vite:esbuild'));
    (0, uni_cli_shared_1.removePlugins)(removedPlugins, config);
    // console.log(plugins.map((p) => p.name))
    // 强制不inline
    config.build.assetsInlineLimit = 0;
    (0, uni_cli_shared_1.injectAssetPlugin)(config, { isAndroidX: isAndroidVdom });
}
