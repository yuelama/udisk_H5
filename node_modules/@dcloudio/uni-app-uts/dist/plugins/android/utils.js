...
exports.genUVueClassName = exports.detectAutoImports = exports.transformUniCloudMixinDataCom = exports.genAutoImportsCode = exports.transformAutoImport = exports.getUniCloudObjectInfo = exports.getUniCloudSpaceList = exports.parseUTSImportFilename = exports.parseUTSRelativeFilename = exports.stringifyMap = exports.kotlinOutDir = exports.createResolveError = exports.parseImports = exports.createTryResolve = exports.wrapResolve = exports.ENTRY_FILENAME = exports.UVUE_CLASS_NAME_PREFIX = void 0;
...
const ENTRY_FILENAME = () => {
    const entryFileName = (0, uni_cli_shared_1.resolveMainUtsName)();
...
function genUVueClassName(fileName, classNamePrefix) {
    return process.env.UNI_COMPILE_TARGET === 'ext-api'
        ? // components/map/map.vue => UniMap
            (0, uni_cli_shared_1.genUTSClassName)(path_1.default.basename(fileName), classNamePrefix) +
                ((0, uni_cli_shared_1.isUniPageFile)(fileName) ? 'Page' : 'Component')
        : (0, uni_cli_shared_1.genUTSClassName)(fileName, classNamePrefix);
}
exports.genUVueClassName = genUVueClassName;
