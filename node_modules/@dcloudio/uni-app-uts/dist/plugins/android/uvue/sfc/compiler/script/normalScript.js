...
function processTemplate(sfc, { relativeFilename, bindingMetadata, className, rootDir, sourceMap, }, pluginContext) {
    ...
    const { code, ast, preamble, elements, map, easyComponentAutoImports, preambleMap, } = (0, template_2.genTemplateCode)(sfc, options);
