...
function init() {
    ...
    const uasm = isDom2 ? (0, uni_cli_shared_1.initUasmTransformOptions)('app-android') : undefined;
    ...
    return [
        ...
        ...((0, uni_cli_shared_1.isNormalCompileTarget)()
            ? [
                (0, uni_cli_shared_1.uniStatsPlugin)(),
                ...(isDom2Dynamic || !isDev ? [] : [(0, devPlugin_1.uniAppXAndroidEngineDevPlugin)()]),
            ]
            : []),
    ];
}
