...
function init() {
    ...
    const uasm = isDom2 ? (0, uni_cli_shared_1.initUasmTransformOptions)('app-harmony') : undefined;
    ...
    return [
            ...
            ? [
                (0, uni_cli_shared_1.uniVaporScriptPlugin)({
                    sharedDataLibName: !isDom2Dynamic
                        ? utils_1.SHARED_DATA_LIB_IMPORT_SOURCE
                        : undefined,
                    uasm,
                }),
            ]
        ...
        (0, uni_cli_shared_1.resolveUTSCompiler)().uts2js({
            ...
            sharedDataLibName: isDom2 && !isDom2Dynamic ? utils_1.SHARED_DATA_LIB_IMPORT_SOURCE : undefined,
