...
exports.builtInComponents = exports.builtInCustomElements = exports.isFilterExpr = exports.removeAttribute = exports.isStaticLiteral = exports.isReferencedByIds = exports.findReferencedScope = exports.rewriteExpression = exports.rewriteExpressionWithoutProperty = exports.parseExprWithRewriteClass = exports.parseExprWithRewrite = exports.rewriteWithHelper = exports.rewriteSpreadElement = exports.filterName = exports.filterObserverName = exports.addUniViewAutoImportFilter = exports.SCOPED_SLOT_IDENTIFIER = exports.FILTER_SET_ELEMENT_ANIMATION = exports.FILTER_SET_ELEMENT_STYLE = exports.FILTER_MODULE_FILE_NAME = exports.FILTER_MODULE_NAME = exports.ATTR_SET_ELEMENT_ANIMATION = exports.ATTR_SET_ELEMENT_STYLE = exports.ATTR_ELEMENT_TAG = exports.ATTR_ELEMENT_ID = exports.ATTR_COM_TYPE = exports.ATTR_VUE_REF_IN_FOR = exports.ATTR_VUE_REF = exports.ATTR_VUE_PROPS = exports.ATTR_VUE_SLOTS = exports.ATTR_VUE_ID = void 0;
...
function addUniViewAutoImportFilter(context) {
    const hasFilter = context.autoImportFilters.some((filter) => filter.name === exports.FILTER_MODULE_NAME);
    if (hasFilter) {
        return;
    }
    context.autoImportFilters.push({
        name: exports.FILTER_MODULE_NAME,
        id: exports.FILTER_MODULE_FILE_NAME,
        type: 'filter',
    });
}
exports.addUniViewAutoImportFilter = addUniViewAutoImportFilter;
...
exports.builtInCustomElements = [
    'uni-cloud-db-element',
    'uni-loading-element',
];
exports.builtInComponents = ['unicloud-db', 'uniloading'];
