 ...
 */
export declare function rewriteBinding({ tag, props }: ComponentNode, context: TransformContext, externalClasses?: string[], preserveDynamicExternalClasses?: boolean): void;
