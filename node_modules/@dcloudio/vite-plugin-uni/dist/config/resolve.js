...
const customResolver = (updatedId, importer) => {
    const independentRoot = (0, uni_cli_shared_1.resolveIndependentRoot)(updatedId, importer, process.env.UNI_INPUT_DIR, process.env.UNI_PLATFORM);
    updatedId = (0, uni_cli_shared_1.withoutIndependentRoot)(updatedId).split('?')[0];
    ...
    if (utsModuleFile) {
        return (0, uni_cli_shared_1.withIndependentRootIfNeeded)(uni_cli_shared_1.isWindows ? (0, uni_cli_shared_1.normalizePath)(utsModuleFile) : utsModuleFile, independentRoot, process.env.UNI_INPUT_DIR);
    }
    ...
    if (resolveId) {
        return (0, uni_cli_shared_1.withIndependentRootIfNeeded)(resolveId, independentRoot, process.env.UNI_INPUT_DIR);
    }
    const resolvedId = (0, uni_cli_shared_1.requireResolve)(updatedId, importer || process.env.UNI_INPUT_DIR);
    return (0, uni_cli_shared_1.withIndependentRootIfNeeded)(uni_cli_shared_1.isWindows ? (0, uni_cli_shared_1.normalizePath)(resolvedId) : resolvedId, independentRoot, process.env.UNI_INPUT_DIR);
};
