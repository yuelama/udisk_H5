...
function initPluginUniOptions(UniVitePlugins) {
    ...
    const styleOptions = {};
    let compiler;
    let uniAppXVaporScriptTransform;
    UniVitePlugins.forEach((plugin) => {
        const { compiler: pluginTemplateCompiler, uniAppXVaporScriptTransform: pluginUniAppXVaporScriptTransform, copyOptions: pluginCopyOptions, compilerOptions: pluginCompilerOptions, jsxOptions: pluginJsxOptions, styleOptions: pluginStyleOpitons, } = plugin.uni || {};
