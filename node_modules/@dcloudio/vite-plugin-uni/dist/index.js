...
exports.shouldMoveSourceMapFromCache = exports.runBuild = exports.runDev = void 0;
...
const rewriteImportVue_1 = require("./uvue/plugins/rewriteImportVue");
...
function uniPlugin(rawOptions = {}) {
    ...
    const plugins = (0, uni_cli_shared_1.isUniAppXAndroidNative)()
        ? createUVueAndroidPlugins(options)
        : createPlugins(options);
    // x 提供 auto import（非android、android自行处理）
    if (process.env.UNI_APP_X === 'true' && !(0, uni_cli_shared_1.isUniAppXAndroidNative)()) {
    ...
    if (process.env.UNI_APP_OUTPUT_FORMAT === 'esm') {
        plugins.push((0, rewriteImportVue_1.rewriteImportVuePlugin)());
    }
    return plugins;
}
...
function createPlugins(options) {
    ...
    plugins.unshift((0, vue_1.createPluginVueInstance)((0, vue_1.initPluginVueOptions)(options, uniPluginOptions)));
...
function shouldMoveSourceMapFromCache() {
    return (process.env.UNI_APP_X === 'true' &&
        process.env.UNI_APP_X_CACHE_DIR &&
        process.env.NODE_ENV !== 'development' &&
        ((0, uni_cli_shared_1.isUniAppXIOS)() || (0, uni_cli_shared_1.isUniAppXAndroidJsEngine)()));
}
exports.shouldMoveSourceMapFromCache = shouldMoveSourceMapFromCache;
