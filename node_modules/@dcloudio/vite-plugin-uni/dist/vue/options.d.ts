...
export declare function initPluginVueOptions(options: VitePluginUniResolvedOptions, uniPluginOptions: Required<Omit<Required<UniVitePlugin>['uni'], 'compiler' | 'uniAppXVaporScriptTransform'>> & Pick<NonNullable<UniVitePlugin['uni']>, 'compiler' | 'uniAppXVaporScriptTransform'>): VueOptions;
