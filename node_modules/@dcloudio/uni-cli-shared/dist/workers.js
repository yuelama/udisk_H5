...
exports.initUniXCompilerRootWorkers = exports.uniJavaScriptWorkersPlugin = exports.genAlipayWorkerRuntimeImportCode = exports.normalizeJavaScriptWorkerSource = exports.resolveWorkersDir = exports.uniWorkersPlugin = exports.initWorkers = exports.getWorkersRootDirs = exports.resolveWorkersRootDir = exports.getWorkers = void 0;
...
function uniWorkersPlugin() {
    ...
    const uniXKotlinCompiler = platform === 'app-android'
        ? (0, uts_1.resolveUTSCompiler)().createUniXKotlinCompilerOnce({
            resolveWorkers,
            loadUasmTransformer: (0, uasm_1.initUasmTransformerCreator)('app-android'),
    ...
    const uniXSwiftCompiler = platform === 'app-ios'
        ? (0, uts_1.resolveUTSCompiler)().createUniXSwiftCompilerOnce({
            resolveWorkers,
            loadUasmTransformer: (0, uasm_1.initUasmTransformerCreator)('app-ios'),
        })
        : null;
...
function genAlipayWorkerRuntimeImportCode(file, workerRootDir = resolveWorkersRootDir()) {
    let workerRuntimePath = (0, utils_1.normalizePath)(path_1.default.relative(path_1.default.dirname(file), path_1.default.join(workerRootDir, 'uni-worker.js')));
    if (!workerRuntimePath.startsWith('.')) {
        workerRuntimePath = './' + workerRuntimePath;
    }
    return `import '${workerRuntimePath}';`;
}
exports.genAlipayWorkerRuntimeImportCode = genAlipayWorkerRuntimeImportCode;
