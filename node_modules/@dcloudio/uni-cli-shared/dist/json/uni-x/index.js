...
function updateUniXPageOptions(pagesJson) {
    ...
    pagesJson.pages.forEach((page) => {
        pageOptions.set(page.path, normalizeRootPageOptions(page.style, pagesJson.globalStyle));
    });
    uniXPageOptionsCache.set(inputDir, pageOptions);
}
function normalizeRootPageOptions(pageStyle, globalStyle) {
    const androidRefresherColor = pageStyle?.androidRefresherColor ?? globalStyle.androidRefresherColor;
    const backgroundColor = pageStyle?.backgroundColor ?? globalStyle.backgroundColor;
    return {
        disableScroll: pageStyle?.disableScroll === true || undefined,
        enablePullDownRefresh: (pageStyle && isEnablePullDownRefresh(pageStyle)) || undefined,
        ...
        androidOverscroll: pageStyle?.androidOverscroll ?? globalStyle.androidOverscroll,
