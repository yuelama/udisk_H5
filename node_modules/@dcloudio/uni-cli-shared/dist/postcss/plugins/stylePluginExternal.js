        ...
        prepare() {
            ...
            return {
                OnceExit(root) {
                    ...
                    if ((0, externalClasses_1.isAlipayXStyleIsolation)()) {
 ...
 */
function processAlipayStyleIsolation(root) {
    const filePath = root.source?.input?.file;
    if (!filePath) {
        return;
    }
    const prefix = (0, utils_1.isAppVue)(filePath)
        ? '-a-'
        : (0, pages_1.isUniPageFile)(filePath)
            ? '-p-'
            : '-c-';
        ...
        rule.selector = (0, postcss_selector_parser_1.default)((selectorRoot) => {
            selectorRoot.each((selector) => {
                ...
                selector.walkClasses((classNode) => {
                    if ((0, externalClasses_1.isAlipayStyleIsolationClass)(classNode.value)) {
                        throw rule.error(`支付宝小程序样式隔离不允许 class 使用保留前缀：${classNode.value}`);
                    }
                });
