...
function createJsStylePlaceholderRegExp(id) {
    const hashId = (0, hash_sum_1.default)(id);
    return new RegExp(`\\{\\s*(?:"${exports.JS_STYLE_PLACEHOLDER_MARKER}"|'${exports.JS_STYLE_PLACEHOLDER_MARKER}'|${exports.JS_STYLE_PLACEHOLDER_MARKER})\\s*:\\s*(?:"${hashId}"|'${hashId}')\\s*\\}`, 'g');
}
exports.createJsStylePlaceholderRegExp = createJsStylePlaceholderRegExp;
exports.ANY_JS_STYLE_PLACEHOLDER_RE = new RegExp(`\\{\\s*(?:"${exports.JS_STYLE_PLACEHOLDER_MARKER}"|'${exports.JS_STYLE_PLACEHOLDER_MARKER}'|${exports.JS_STYLE_PLACEHOLDER_MARKER})\\s*:\\s*(?:"[^"]+?"|'[^']+?')\\s*\\}`, 'g');
